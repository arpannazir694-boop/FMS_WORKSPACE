...
(function () {
  ...
  function injectStyles() {
    ...
    var css = ''
      ...
      + '.ai-clear-btn .material-icons-round{font-size:16px;}'
      ...
      + '.ai-chat-shell,.ai-content-scroll{scrollbar-width:none;-ms-overflow-style:none;}'
      + '.ai-chat-shell::-webkit-scrollbar,.ai-content-scroll::-webkit-scrollbar{display:none;width:0;height:0;}'
      ...
      + '.ai-chat-main{display:flex;flex:1;flex-direction:column;min-width:0;background:rgba(255,250,245,.3);}'
